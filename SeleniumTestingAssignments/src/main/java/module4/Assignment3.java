...
public class Assignment3 {
	...
	public static void main(String[] args) {
		...
		//birth date
		WebElement birthDate = driver.findElement(By.xpath("/html/body/div[3]/div[2]/div/div/div[2]/div/div/div[1]/form/div[1]/div[5]/div[2]/span/span/select[1]"));
		Select select = new Select(birthDate);
		select.selectByIndex(2);
		
		//birth month
		WebElement birthMonth = driver.findElement(By.xpath("/html/body/div[3]/div[2]/div/div/div[2]/div/div/div[1]/form/div[1]/div[5]/div[2]/span/span/select[2]"));
		select = new Select(birthMonth);
		select.selectByIndex(2);
		
		//birth year
		WebElement birthYear = driver.findElement(By.xpath("/html/body/div[3]/div[2]/div/div/div[2]/div/div/div[1]/form/div[1]/div[5]/div[2]/span/span/select[3]"));
